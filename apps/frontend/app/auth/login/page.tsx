    ...
    <div className="min-h-screen bg-[#020617] text-slate-100 font-sans flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-[400px] relative z-10">
        <div className="flex flex-col items-center mb-12">
          ...
          {reason === "expired" && (
            <div className="flex items-center gap-2.5 mt-8 rounded-2xl border border-amber-500/20 bg-amber-500/5 px-4 py-3 backdrop-blur-sm">
        ...
        <div className="bg-slate-900/40 backdrop-blur-xl border border-white/5 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden group">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              ...
              >
                <div
                  className={`absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none transition-colors ${isFocused === "email" ? "text-sky-400" : "text-slate-700"}`}
                >
                  <Mail size={16} />
                </div>
                <input
            ...
            <div className="space-y-2">
              ...
              >
                <div
                  className={`absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none transition-colors ${isFocused === "password" ? "text-sky-400" : "text-slate-700"}`}
                >
                  <Lock size={16} />
                </div>
                <input
          ...
          <div className="mt-8 pt-6 border-t border-white/5 flex flex-col items-center gap-4">
            <Link
              href="/auth/register"
              className="text-[9px] font-mono text-slate-600 hover:text-sky-400 uppercase tracking-[0.2em] transition-colors italic"
            >
